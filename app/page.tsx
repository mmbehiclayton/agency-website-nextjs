...
export default function Home() {
  return (
    <div className="overflow-clip inset-0 -z-10 h-screen w-full bg-[#fafafa] bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
      ...
      <Element name="top" className="overflow-hidden rounded-[6px] top-5 sticky md:mx-auto z-50 
      ...
      justify-between py-6 px-4 md:px-8 mx-6">
        ...
        <div className="absolute right-1/2 translate-x-1/2 transform">
          <div className="hidden md:flex gap-x-10 items-center text-gray-700 font-medium text-lg cursor-pointer">
            ...
            <ScrollLink to="guarantees" smooth={true} className="hover:text-blue-500">
              Guarantees 
            </ScrollLink>
        ...
        <div className="flex items-center gap-x-4">
          <a href="tel:0717104727" className="hidden lg:flex">
            ...
            <Link href={'/meeting'} className="py-3 px-6 
            hover:bg-[#abcbff] 
            rounded-[6px]
            border-2
            border-black
